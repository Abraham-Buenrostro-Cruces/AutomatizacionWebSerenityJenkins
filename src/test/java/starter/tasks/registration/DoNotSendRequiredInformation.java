...
public class DoNotSendRequiredInformation implements Task {
    private final String expectedName;
    private final String expectedLastName;

    public DoNotSendRequiredInformation(String expectedName, String expectedLastName) {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Enter.theValue(expectedName).into(RegisterForm.INPUT_NAME),
